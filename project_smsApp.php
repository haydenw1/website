...
<html lang="en">
  ...
  <body>
    ...
    <div class="container container_section container_section_story">
      ...
      <div class="swipeSlider swipeSlider--no-caption--gray" id="0">
      </div>
      ...
      <p><span class="bold">Pictured below are screenshots from an interactive article I developed for our app.</span> In this article users touch sections of a "donut" graph to see what percentage of our students get a co-op in that industry, and read other app articles related to that industry.</p>
      ...
      <p>I had to learn how to use new technologies and software, brainstorm content and user relationships, and work through difficulties to establish efficient project workflows.</p>
  ...
  <script>
    ...
    $( document ).ready( function() {
      swipeSlider.setUp( testData.smsApp );
    });
